...
DLLEXPORT void getG3Correlations_new(char **file_list, int file_list_length, double max_time, double bin_width, double pulse_spacing, int max_pulse_distance, PyObject *numer, int32 *denom, bool calc_norm, int num_cpu_threads, int num_cpu_threads_proc) {
...
DLLEXPORT void getG2Correlations_new(char **file_list, int file_list_length, double max_time, double bin_width, double pulse_spacing, int max_pulse_distance, PyObject *numer, int32 *denom, bool calc_norm, int num_cpu_threads_files, int num_cpu_threads_proc) {
...
DLLEXPORT void getG2Correlations_pulse_2(char **file_list, int file_list_length, double min_tau_1, double max_tau_1, double min_tau_2, double max_tau_2, double bin_width, PyObject *numer, int32 *denom, int num_cpu_threads_files) {
